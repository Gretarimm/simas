...
<body>
			...
			<div>
				<div class="plentele">
					...
					<form>
						...
						<label for=""></label>
						<input type="number" id="milai" placeholder="1 M"><br>
						<p class="p">Minimum amount 10 Millions</p>
						<label for="">The total price €:</label>
						<input type="number" id="eurai" placeholder="€" ><br>
						<label for="">The total price $:</label>
						<input type="number" id="USD" placeholder="$"><br>
						<label for="">The total price £:</label>
						<input type="number" id="GBP" placeholder="£"><br>
						<a href="https://www.facebook.com/simas.ivanovas" class="button" target="_blank">BUY NOW</a>
					</form>
				</div>
				<div class="alentele">
					<h1>Buy Runescape<br><span>RS3</span> Gold in Milions</h1>
					<form>
						<p>Amount in Millions (1 for : 1 Milion)</p>
						<label for=""></label>
	...
	<section id="pirma" name="SEL GOLD">
		<div class="wrapper">
			<h1>SELL YOUR RUNESCAPE GOLD</h1>
			<div>
				<div class="palentele">
					<h1>Sell your <span>OSRS</span> Gold</h1>
					<form>
						<p>Amount in Millions (1 for : 1 Milion)</p>
						<label for=""></label>
				...
				<div class="aalentele">
					<h1>Sell your <span>RS3</span> Gold</h1>
					<form>
						<p>Amount in Millions (1 for : 1 Milion)</p>
						<label for=""></label>
